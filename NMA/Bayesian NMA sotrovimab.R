...
data=read_csv("NMA/blood/allergic_reac.csv") %>%
...
data=read_excel("NMA/blood/Binary outcomes_non severe_long data for analysis_20211101.xlsx", range = "A2:E39") %>%
  as.data.frame() %>% rename(study=stauthor,responders=responder)
...
data=read_excel("NMA/blood/Binary outcomes_non severe_long data for analysis_20211101.xlsx", range = "K2:O20") %>%
  as.data.frame() %>% rename(study=stauthor,responders=responder)
