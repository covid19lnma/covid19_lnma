...
data=read_excel("NMA/drugs/All binary outcomes_long data for analysis_20211122.xlsx", range = "A2:F553") %>%
...
data=read_excel("NMA/drugs/All binary outcomes_long data for analysis_20211122.xlsx", range = "X2:AC78") %>%
  as.data.frame() %>% rename(study=stauthor,responders=responder) #%>%
