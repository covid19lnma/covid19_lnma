...
data=read.csv("pairwise/drugs/mortality - wide data format_jaki.csv")
...
data=read.csv("pairwise/drugs/mechanical ventilation - wide data format_jaki.csv")
data=data %>% mutate(t1=gsub("^\\d+_(.*$)","\\1",t1),t2=gsub("^\\d+_(.*$)","\\1",t2)) 
...
data=read.csv("pairwise/drugs/Adverse effects leading to discont - wide data format_jaki.csv")
data=data %>% mutate(t1=gsub("^\\d+_(.*$)","\\1",t1),t2=gsub("^\\d+_(.*$)","\\1",t2)) 
...
data=read.csv("pairwise/drugs/Time to symptom resolution_wide data_jaki.csv")
data=data %>% mutate(t1=gsub("^\\d+_(.*$)","\\1",t1),t2=gsub("^\\d+_(.*$)","\\1",t2)) 
...
data=read.csv("pairwise/drugs/Time to viral clearance_wide data_jaki.csv")
data=data %>% mutate(t1=gsub("^\\d+_(.*$)","\\1",t1),t2=gsub("^\\d+_(.*$)","\\1",t2)) 
...
data=read.csv("pairwise/drugs/Duration of hospitalization_wide data_jaki.csv")
data=data %>% mutate(t1=gsub("^\\d+_(.*$)","\\1",t1),t2=gsub("^\\d+_(.*$)","\\1",t2)) 
...
data=read.csv("pairwise/drugs/Duration of ventilation_wide data_jaki.csv")
data=data %>% mutate(t1=gsub("^\\d+_(.*$)","\\1",t1),t2=gsub("^\\d+_(.*$)","\\1",t2)) 
...
data=read.csv("pairwise/drugs/ICU length of stay_wide data_jaki.csv")
data=data %>% mutate(t1=gsub("^\\d+_(.*$)","\\1",t1),t2=gsub("^\\d+_(.*$)","\\1",t2)) 
...
data=read.csv("pairwise/drugs/Ventilator-free days_wide data_jaki.csv")
data=data %>% mutate(t1=gsub("^\\d+_(.*$)","\\1",t1),t2=gsub("^\\d+_(.*$)","\\1",t2)) 
